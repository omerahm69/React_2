...
const HeroSection = () => {
  // Local language state (optional, for RTL support)
  const [language, setLanguage] = useState<"en" | "ar" | "ti">("en");
  const rtl = language === "ar";

  // Hardcoded "translations"
  const t = {
    hero: {
      title: "Welcome to Massawa Heritage",
      subtitle: "Discover the city",
      description:
        "Explore Massawa's cultural heritage, historic architecture, and vibrant community activities.",
    },
    nav: {
      urbanHeritage: "Urban Heritage",
      aboutUs: "About Us",
    },
  };
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <h1
            ...
            style={{
              ...
              textShadow:
                "0 8px 40px rgba(0,0,0,0.6), 0 2px 10px rgba(0,0,0,0.4)",
            }}
          >
            {t.hero.title}
          </h1>
          ...
          >
            ...
            >
              ...
              <span className="relative z-10 group-hover:translate-x-2 transition-transform text-xl">
                →
              </span>
